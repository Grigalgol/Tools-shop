...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drills.add(new Drill(getString(R.string.drill_interskoll_title), getString(R.string.drill_interskoll_info), R.drawable.interskol));
        ...
        listViewDrills.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("image", drill.getImageResourceId());
